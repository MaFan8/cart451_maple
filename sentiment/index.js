...
// "body parser" is need to deal with post requests and format it
...
app.get('/clientSentiment', function(req, res) {
    res.sendFile(__dirname + '/publicToStart2022/clientSentiment.html');
});

/// use this VERB for getting posted data...
app.post('/getSentiment',handlePost); // handlePost = callback
